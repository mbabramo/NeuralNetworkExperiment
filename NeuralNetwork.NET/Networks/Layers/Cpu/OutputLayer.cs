...
namespace NeuralNetworkNET.Networks.Layers.Cpu
{
    ...
    internal sealed class OutputLayer : OutputLayerBase
    {
        ...
        {
            if (activation == ActivationType.Softmax || cost == CostFunctionType.LogLikelihood)
                throw new ArgumentException("The softmax activation and log-likelihood cost function must be used together in a softmax layer");
